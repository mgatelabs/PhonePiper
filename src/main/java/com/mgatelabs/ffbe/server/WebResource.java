...
public class WebResource {
    ...
    public PrepResult prepProcess(@RequestBody Map<String, String> values) {
        ...
        frameChoices = new FrameChoices(Constants.ACTION_RUN, Constants.MODE_SCRIPT, playerDefinition, "", values.get("script"), values.get("script2"), null, values.get("device"), values.get("view"), values.get("view2"));
    ...
    public PrepResult editView(@RequestBody Map<String, String> values) {
        ...
        frameChoices = new FrameChoices(Constants.ACTION_EDIT, Constants.MODE_VIEW, playerDefinition, "", values.get("script"), values.get("script2"), null, values.get("device"), values.get("view"), values.get("view2"));
